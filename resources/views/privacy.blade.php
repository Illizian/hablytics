...
@section('content')
    <h1 class="mb-4 font-bold text-lg">Privacy Policy</h1>

    <p class="mb-4">Your privacy is important to us. It is Alex Scotton Web Development Ltd's policy to respect your privacy regarding any information we may collect from you across our website, https://hablytics.com, and other sites we own and operate.</p>
    ...
    <p class="mb-4">This policy is effective as of 26 September 2019.</p>
@endsection
